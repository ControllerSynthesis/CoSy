 ...
 */
public class p01__ENFORCE_BLOCKFREE__T05_05_LR_PARSER___FUNLRPARSER_example3 {
    ...
    public void Test() {
        ...
        try {
            ...
            reader.parse("src/test/resources/unit_tests/p01__ENFORCE_BLOCKFREE__T05_04_LR_MACHINE___FUNLRMACHINE_example3.xml");
            ...
            assert (machine.get_epda_delta().size() == 44);
            assert (machine.get_epda_states().size() == 30);
            assert (machine.get_epda_gamma().size() == 1);
            assert (machine.get_epda_events().size() == 10);
            ...
            assert (output_parser.get_parser_step_labels().size() == 63);
            ...
            assert Comparison_equal.compare_equal_with_empty_check(Compare_CFG_PARSER.compare_equal(
                    ...
                    1000,
                    200000));
            assert output_parser.is_deterministic();

            parser renamed = T02_02_PARSER_TYPE_CONVERSION.F_PARSER_TC(output_parser);
