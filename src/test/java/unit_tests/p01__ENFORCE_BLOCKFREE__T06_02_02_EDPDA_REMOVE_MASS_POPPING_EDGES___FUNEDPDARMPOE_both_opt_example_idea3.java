 ...
 */
public class p01__ENFORCE_BLOCKFREE__T06_02_02_EDPDA_REMOVE_MASS_POPPING_EDGES___FUNEDPDARMPOE_both_opt_example_idea3 {
    ...
    public void Test() {
        ...
        try {
            ...
            assert (output1.get_epda_delta().size() == 5);
            assert (output2.get_epda_states().size() == 14);
            assert (output2.get_epda_delta().size() == 19);
        } catch (Exception e) {
            e.printStackTrace();
            assert (false);
        }
