 ...
 */
public class p01__ENFORCE_BLOCKFREE__T06_02_02_EDPDA_REMOVE_MASS_POPPING_EDGES___FUNEDPDARMPOE_example_idea3 {
    ...
    public void Test() {
        ...
        try {
            ...
            assert Comparison_equal.compare_equal_with_empty_check(Compare_EPDA_EPDA.compare_equal(
                    ...
                    1000,
                    200000));
            assert (output.get_epda_states().size() == 19);
            assert (output.get_epda_delta().size() == 25);
        } catch (Exception e) {
            e.printStackTrace();
            assert (false);
        }
