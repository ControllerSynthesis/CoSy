 ...
 */
public class p01__ENFORCE_BLOCKFREE__T04_CFG_FIRST___extra1 {
    ...
    public void Test() {
        ...
        try {
            ...
            reader.parse("src/test/resources/unit_tests/p01__ENFORCE_BLOCKFREE__T04_CFG_FIRST___extra1.xml");
            ...
            two_elements__teA<string_symbol, string_symbol> nonterminal_C = new two_elements__teA<>((string_symbol) reader.get_parsed_element("nonterminal_C"));
            ...
            two_elements__teB<string_symbol, string_symbol> event_d = new two_elements__teB<>((string_symbol) reader.get_parsed_element("event_d"));
            Set<List<string_symbol>> output;

            output = T04_CFG_FIRST.F_CFG_FIRST(input, 1, General_List.list_by_enumeration(nonterminal_S));
            System.out.println(output);
            assert (output.size() == 2);

            output = T04_CFG_FIRST.F_CFG_FIRST(input, 1, General_List.list_by_enumeration(nonterminal_A));
            System.out.println(output);
            assert (output.size() == 2);

            output = T04_CFG_FIRST.F_CFG_FIRST(input, 1, General_List.list_by_enumeration(nonterminal_B));
            System.out.println(output);
            assert (output.size() == 1);

            output = T04_CFG_FIRST.F_CFG_FIRST(input, 1, General_List.list_by_enumeration(nonterminal_C));
            System.out.println(output);
            assert (output.size() == 1);

            output = T04_CFG_FIRST.F_CFG_FIRST(input, 1, General_List.list_by_enumeration(nonterminal_S, nonterminal_A, event_b));
            System.out.println(output);
            assert (output.size() == 2);
