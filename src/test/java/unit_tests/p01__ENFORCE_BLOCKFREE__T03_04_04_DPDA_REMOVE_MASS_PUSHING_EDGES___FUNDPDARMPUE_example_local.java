 ...
 */
public class p01__ENFORCE_BLOCKFREE__T03_04_04_DPDA_REMOVE_MASS_PUSHING_EDGES___FUNDPDARMPUE_example_local {
    ...
    public void Test() {
        ...
        try {
            ...
            reader.parse("src/test/resources/unit_tests/p01__ENFORCE_BLOCKFREE__T03_04_04_DPDA_REMOVE_MASS_PUSHING_EDGES___FUNDPDARMPUE_example_local.xml");
            ...
            assert (output.get_epda_states().size() == 8);
            assert (output.get_epda_delta().size() == 9);
