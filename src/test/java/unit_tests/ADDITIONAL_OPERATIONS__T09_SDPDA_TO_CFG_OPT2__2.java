 ...
 */
public class ADDITIONAL_OPERATIONS__T09_SDPDA_TO_CFG_OPT2__2 {
    ...
    public void Test() {
        ...
        try {
            ...
            reader.parse("src/test/resources/unit_tests/ADDITIONAL_OPERATIONS__T09_SDPDA_TO_CFG_OPT2__2.xml");
            ...
            assert (output.get_cfg_step_labels().size() == 3);
            ...
            assert (output2.get_cfg_nonterminals().size() == 3);
            assert (output2.get_cfg_step_labels().size() == 3);
