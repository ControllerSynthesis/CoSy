 ...
 */
public class p01__ENFORCE_BLOCKFREE__T04_CFG_FIRST2___extra1 {
    ...
    public void Test() {
        ...
        try {
            ...
            output = T04_CFG_FIRST2.F_CFG_FIRST(input, 1, General_List.list_by_enumeration(nonterminal_B));
            System.out.println(output);
            assert (output.size() == 1);

            output = T04_CFG_FIRST2.F_CFG_FIRST(input, 1, General_List.list_by_enumeration(nonterminal_C));
            System.out.println(output);
            assert (output.size() == 1);
