 ...
 */
public class p01__ENFORCE_BLOCKFREE__T05_04_LR_MACHINE___FUNLRMACHINE_example2 {
    ...
    public void Test() {
        ...
        try {
            ...
            assert (output.get_epda_delta().size() == 12);
            assert (output.get_epda_states().size() == 12);
            assert (output.get_epda_gamma().size() == 1);
            assert (output.get_epda_events().size() == 6);
