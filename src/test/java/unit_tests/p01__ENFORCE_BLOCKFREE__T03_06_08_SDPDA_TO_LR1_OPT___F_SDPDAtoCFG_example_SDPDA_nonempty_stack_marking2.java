 ...
 */
public class p01__ENFORCE_BLOCKFREE__T03_06_08_SDPDA_TO_LR1_OPT___F_SDPDAtoCFG_example_SDPDA_nonempty_stack_marking2 {
    ...
    public void Test() {
        ...
        try {
            ...
            reader.parse("src/test/resources/unit_tests/p01__ENFORCE_BLOCKFREE__T03_06_08_SDPDA_TO_LR1_OPT___F_SDPDAtoCFG_example_SDPDA_nonempty_stack_marking2.xml");
            ...
            cfg<l2_l3_nonterminals__abstract<symbol__abstract<string_symbol>, symbol__abstract<string_symbol>>, symbol__abstract<string_symbol>>
                    output = ((option__Some<cfg<l2_l3_nonterminals__abstract<symbol__abstract<string_symbol>, symbol__abstract<string_symbol>>, symbol__abstract<string_symbol>>>) T03_06_08_SDPDA_TO_LR1_OPT.F_SDPDA_TO_LR1_OPT(input, T04_APPROXIMATE_POSSIBLE_TOP_STACKS_EPDA.APPROXIMATE_POSSIBLE_TOP_STACKS_EPDA__use_approx(input), 1)).the();
            ...
            assert (output.get_cfg_nonterminals().size() == 13);
            assert (output.get_cfg_step_labels().size() == 19);
            ...
            assert (output2.get_cfg_nonterminals().size() == 8);
            assert (output2.get_cfg_step_labels().size() == 15);
