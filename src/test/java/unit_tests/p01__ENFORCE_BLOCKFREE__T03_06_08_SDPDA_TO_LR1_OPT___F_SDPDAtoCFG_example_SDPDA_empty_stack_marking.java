 ...
 */
public class p01__ENFORCE_BLOCKFREE__T03_06_08_SDPDA_TO_LR1_OPT___F_SDPDAtoCFG_example_SDPDA_empty_stack_marking {
    ...
    public void Test() {
        ...
        try {
            ...
            assert (output.get_cfg_nonterminals().size() == 14);
            ...
            assert (output2.get_cfg_step_labels().size() == 8);
