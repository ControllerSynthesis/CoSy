 ...
 */
public class p01__ENFORCE_BLOCKFREE__T06_02_02_EDPDA_REMOVE_MASS_POPPING_EDGES___FUNEDPDARMPOE_both_opt_example2 {
    ...
    public void Test() {
        ...
        try {
            ...
            reader.parse("src/test/resources/unit_tests/p01__ENFORCE_BLOCKFREE__T06_02_02_EDPDA_REMOVE_MASS_POPPING_EDGES___FUNEDPDARMPOE_example2.xml");
            ...
            assert Comparison_equal.compare_equal_with_empty_check(Compare_EPDA_EPDA.compare_equal(
                    ...
                    1000,
                    200000));
            assert (output1.get_epda_states().size() == 4);
            assert (output1.get_epda_delta().size() == 4);
            assert (output2.get_epda_states().size() == 11);
            assert (output2.get_epda_delta().size() == 16);
        } catch (Exception e) {
            e.printStackTrace();
            assert (false);
        }
