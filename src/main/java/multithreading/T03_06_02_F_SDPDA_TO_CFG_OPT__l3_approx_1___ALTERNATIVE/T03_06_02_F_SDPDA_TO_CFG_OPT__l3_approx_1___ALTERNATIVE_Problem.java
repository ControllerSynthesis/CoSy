 ...
 */
public class T03_06_02_F_SDPDA_TO_CFG_OPT__l3_approx_1___ALTERNATIVE_Problem<state extends General, event extends General, stack extends General> extends Abstract_Problem {

    public List<tuple3<state, General_List<stack>, option__abstract<General_Integer>>> todo;
    public Set<tuple2<state, General_List<stack>>> done;
    public accessibility_graph<state, stack> closure;
    public epda<state, event, stack> epda;
    public int k;

    public T03_06_02_F_SDPDA_TO_CFG_OPT__l3_approx_1___ALTERNATIVE_Problem(
            List<tuple3<state, General_List<stack>, option__abstract<General_Integer>>> todo,
            Set<tuple2<state, General_List<stack>>> done,
