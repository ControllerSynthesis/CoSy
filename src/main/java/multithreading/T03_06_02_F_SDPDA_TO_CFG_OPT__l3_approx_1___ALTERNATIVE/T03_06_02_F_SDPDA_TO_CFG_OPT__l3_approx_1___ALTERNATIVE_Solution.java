 ...
 */
public class T03_06_02_F_SDPDA_TO_CFG_OPT__l3_approx_1___ALTERNATIVE_Solution<state extends General, stack extends General> extends Abstract_Solution {

    public Set<tuple3<state, General_List<stack>, option__abstract<General_Integer>>> found;
    public Set<l2_l3_nonterminals__cons_l3<state, stack>> result;

    public T03_06_02_F_SDPDA_TO_CFG_OPT__l3_approx_1___ALTERNATIVE_Solution(
            Abstract_Problem problem,
            Set<tuple3<state, General_List<stack>, option__abstract<General_Integer>>> found,
